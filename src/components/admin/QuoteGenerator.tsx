...
const TERMS = [
  ...
  { heading: '4. VAT', body: 'SealFix SA is a registered VAT vendor. All prices are subject to Value Added Tax at the current standard rate (15%), where applicable and indicated on this quotation.' },
  ...
  { heading: '11. Cancellation', body: 'Should the client cancel this agreement after acceptance, an administration fee of 20% of the quoted value will be charged. If work has commenced, the client will be liable for all costs incurred to date plus the 20% administration fee.' },
