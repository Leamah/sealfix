...
const inputCls =
  'w-full rounded border border-charcoal-600 bg-charcoal-700 px-3 py-2 text-sm text-sand-100 placeholder:text-sand-500 focus:border-ember-500 focus:outline-none focus:ring-1 focus:ring-ember-500';

const labelCls = 'block text-xs font-semibold uppercase tracking-wide text-sand-400 mb-1';

const tdInput =
  'w-full bg-transparent border-0 text-sm text-sand-100 focus:outline-none placeholder:text-sand-600 px-1 py-0.5';

// ─── Standard T&Cs ────────────────────────────────────────────────────────────

const TERMS = [
  {
    heading: '1. Quotation Validity',
    body: 'This quotation is valid for 30 days from the date of issue. SealFix SA reserves the right to revise pricing after this period to account for fluctuations in material costs, labour rates, or fuel levies. A revised quotation will be issued upon request.',
  },
  {
    heading: '2. Acceptance',
    body: 'This quotation becomes a binding agreement only upon written acceptance by the client (signed copy of this document or written confirmation by email). Verbal acceptance is not binding.',
  },
  {
    heading: '3. Payment Terms',
    body: '50% deposit is required prior to commencement of work. The balance is due on the day of practical completion. Invoices not settled within 7 days of the due date will attract interest at the maximum permissible rate under the National Credit Act (No. 34 of 2005). SealFix SA reserves the right to suspend or terminate works on accounts overdue by more than 14 days.',
  },
  {
    heading: '4. VAT',
    body: 'SealFix SA is a registered VAT vendor. All prices are subject to Value Added Tax at the current standard rate (15%), where applicable and indicated on this quotation.',
  },
  {
    heading: '5. Site Access & Preparation',
    body: "The client is responsible for ensuring safe, unobstructed access to the site on the agreed commencement date. Any delays caused by restricted access, incomplete site preparation, or third-party interference will be for the client's account at a standing-time rate. The client must ensure the site is free of vehicles, equipment, or any obstructions prior to work commencing.",
  },
  {
    heading: '6. Variations & Additional Work',
    body: 'Any variation to the agreed scope of work — including additional quantities, services, or unforeseen site conditions — must be approved in writing by both parties before execution. Variations will be priced separately and added to the final invoice. SealFix SA accepts no liability for work performed outside the agreed scope without written authorisation.',
  },
  {
    heading: '7. Materials',
    body: "All materials supplied by SealFix SA will be new, fit for purpose, and sourced from reputable South African suppliers. No material substitutions will be made without the client's written consent. Where materials are specified by the client, SealFix SA accepts no responsibility for suitability or performance thereof.",
  },
  {
    heading: '8. Workmanship Warranty',
    body: 'SealFix SA warrants that all work will be carried out in a professional and workmanlike manner in accordance with applicable South African standards. A 12-month workmanship warranty applies from the date of practical completion, covering defects arising from faulty execution. This warranty is void if the surface is subjected to abnormal loads, chemical exposure, or interference by parties other than SealFix SA.',
  },
  {
    heading: '9. Limitation of Liability',
    body: "SealFix SA's total liability under this agreement shall not exceed the total contract value. SealFix SA shall not be liable for any indirect, consequential, or special losses, including but not limited to loss of income, business interruption, or damage to third-party property, except where such loss arises from gross negligence or wilful misconduct.",
  },
  {
    heading: '10. Insurance',
    body: 'SealFix SA maintains public liability insurance for the duration of works. A certificate of insurance is available on request. The client is advised to maintain their own property and asset insurance throughout the contract period.',
  },
  {
    heading: '11. Cancellation',
    body: 'Should the client cancel this agreement after acceptance, an administration fee of 20% of the quoted value will be charged to cover preparation, procurement, and scheduling costs already incurred. If work has commenced, the client will be liable for all costs incurred to date, including materials, labour, and standing time, plus the 20% administration fee.',
  },
  {
    heading: '12. Dispute Resolution',
    body: 'In the event of a dispute, the parties agree to first attempt resolution through good-faith negotiation. Failing resolution within 14 days, the matter shall be referred to a mutually agreed mediator under the auspices of the Arbitration Foundation of Southern Africa (AFSA). This agreement is governed by the laws of the Republic of South Africa.',
  },
  {
    heading: '13. Consumer Protection Act',
    body: 'Where applicable, this agreement is subject to the Consumer Protection Act 68 of 2008. Consumers are entitled to a cooling-off period of 5 business days for transactions concluded as a result of direct marketing.',
  },
];
...
function QuoteDocument({ q }: { q: FinalQuote }) {
  ...
  const cell: React.CSSProperties = { padding: '5px 0', verticalAlign: 'top' };
    ...
    <div id="quote-document">
      ...
      >
            ...
            <tr>
              <td style={{ verticalAlign: 'top', width: '55%' }}>
                ...
                <img
                  src="/images/logo.png"
                  alt="SealFix SA"
                  style={{ height: 52, display: 'block', marginBottom: 8, objectFit: 'contain' }}
                />
                <div style={{ fontSize: '8.5pt', color: '#555', lineHeight: 1.65 }}>
                  <strong style={{ fontSize: '10.5pt', color: '#1a1a1a' }}>{COMPANY.legalName}</strong>
                  <br />
              ...
              <td style={{ verticalAlign: 'top', textAlign: 'right' }}>
                <div style={{ fontSize: '22pt', fontWeight: 700, letterSpacing: 2, textTransform: 'uppercase', marginBottom: 8 }}>
                  Quotation
                </div>
                <table style={{ marginLeft: 'auto', borderCollapse: 'collapse', fontSize: '9pt' }}>
                  <tbody>
                    {[
                      ...
                      ...(meta.poRef ? [['Client Ref.', meta.poRef]] : []),
                    ].map(([lbl, val]) => (
                      <tr key={lbl}>
                        <td style={{ color: '#666', paddingRight: 10, paddingBottom: 3 }}>{lbl}</td>
                        <td style={{ fontWeight: 600, textAlign: 'right', paddingBottom: 3 }}>{val}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
          ...
          <tbody>
            <tr>
              ...
              <td style={{ verticalAlign: 'top', width: '46%', background: '#f8f8f8', padding: '10px 14px', borderRadius: 4 }}>
                ...
                {client.siteAddress
                  ? <div style={{ fontSize: '9.5pt', whiteSpace: 'pre-line' }}>{client.siteAddress}</div>
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '10pt' }}>
          ...
          <tfoot>
            ...
            <tr style={{ borderTop: '2px solid #e8a020', background: '#fffbf2' }}>
              <td colSpan={4} style={{ paddingTop: 8, paddingBottom: 8, textAlign: 'right', fontWeight: 700, fontSize: '12pt' }}>
                TOTAL{meta.vatEnabled ? ' (incl. VAT)' : ''}
              </td>
        ...
        <div style={{ marginTop: 24 }}>
          ...
          <div style={{ fontSize: '9pt', color: '#555', marginBottom: 14 }}>
            By signing below, I/we confirm having read and accepted this quotation and the Standard Terms &amp; Conditions overleaf, and authorise SealFix SA to proceed with the work described above.
          </div>
        ...
        <div style={{ borderTop: '1px solid #ddd', paddingTop: 8, marginTop: 8, fontSize: '8pt', color: '#999', textAlign: 'center' }}>
          ...
          {imageDataUrl && <span> &nbsp;·&nbsp; <em>See Appendix A for site reference image</em></span>}
        </div>
      </div>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 16 }}>
          <div>
            ...
            <div style={{ fontSize: '8.5pt', color: '#777', marginTop: 3 }}>
              {COMPANY.legalName} &nbsp;|&nbsp; Quotation {meta.quoteNo}
            </div>
          </div>
          {/* eslint-disable-next-line @next/next/no-img-element */}
      ...
      {/* ── Page 3: Appendix (image) — only if image attached ── */}
      {imageDataUrl && (
        <div
          style={{
            fontFamily: 'Arial, Helvetica, sans-serif',
        ...
        >
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 12 }}>
            <div>
              <div style={{ fontSize: '14pt', fontWeight: 700, textTransform: 'uppercase', letterSpacing: 1, color: '#1a1a1a' }}>Appendix A</div>
          ...
          {/* Caption */}
          {imageCaption && (
            <div style={{ marginTop: 10, fontSize: '9pt', color: '#555', textAlign: 'center', fontStyle: 'italic' }}>
              {imageCaption}
            </div>
          )}
...
export function QuoteGenerator() {
  const [client, setClient] = useState<ClientDetails>({
    name: '', company: '', phone: '', email: '', address: '', siteAddress: '',
  });
  ...
  const [lines, setLines] = useState<QuoteLine[]>([
    { id: uid(), description: '', qty: 1, unit: 'each', unitPrice: 0 },
  ]);
  ...
  // ── client helpers ──
  function setField(k: keyof ClientDetails, v: string) {
    setClient((p) => ({ ...p, [k]: v }));
  }

  // ── line helpers ──
  const addLine = useCallback(() => {
    setLines((p) => [...p, { id: uid(), description: '', qty: 1, unit: 'each', unitPrice: 0 }]);
  }, []);
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 gap-8 2xl:grid-cols-[1fr_auto]">

        {/* ══ LEFT: FORM ══ */}
        <div className="space-y-6 min-w-0">

          {/* Quote meta */}
          <div className="rounded border border-charcoal-700 bg-charcoal-800 p-5">
          ...
          {/* Client details */}
          <div className="rounded border border-charcoal-700 bg-charcoal-800 p-5 space-y-4">
            <h3 className="text-sm font-bold uppercase tracking-wide text-sand-200">Client Details</h3>
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
              ...
              <div>
                ...
                <input className={inputCls} value={client.email} onChange={(e) => setField('email', e.target.value)} placeholder="email@example.com" />
              </div>
            </div>
            <div>
              <label className={labelCls}>Billing Address</label>
              <textarea className={inputCls + ' resize-none'} rows={2} value={client.address} onChange={(e) => setField('address', e.target.value)} placeholder="Street, City, Code" />
            </div>
            <div>
              <label className={labelCls}>Site / Project Address</label>
              <input className={inputCls} value={client.siteAddress} onChange={(e) => setField('siteAddress', e.target.value)} placeholder="Where the work will be done" />
            </div>
          </div>
          ...
          <div className="rounded border border-charcoal-700 bg-charcoal-800 p-5">
            <div className="flex items-center justify-between mb-4 gap-3 flex-wrap">
              ...
              <div className="flex items-center gap-2">
                <select
                  className="rounded border border-charcoal-600 bg-charcoal-700 px-2 py-1.5 text-xs text-sand-300 focus:border-ember-500 focus:outline-none"
                ...
                <button
                  onClick={addLine}
                  className="flex items-center gap-1.5 rounded bg-charcoal-700 border border-charcoal-600 px-3 py-1.5 text-xs font-semibold text-sand-200 hover:bg-charcoal-600 transition-colors"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-3.5 w-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2.5}><path d="M12 5v14M5 12h14" /></svg>
                  Add Line
                </button>
              </div>
            </div>
              ...
              <table className="w-full border-collapse text-sm min-w-[600px]">
                <thead>
                  <tr className="border-b border-charcoal-600">
                    <th className="pb-2 text-left text-xs font-semibold uppercase tracking-wide text-sand-400 pr-2 w-[38%]">Description</th>
                    <th className="pb-2 text-right text-xs font-semibold uppercase tracking-wide text-sand-400 px-2 w-[8%]">Qty</th>
                    <th className="pb-2 text-left text-xs font-semibold uppercase tracking-wide text-sand-400 px-2 w-[12%]">Unit</th>
                    <th className="pb-2 text-right text-xs font-semibold uppercase tracking-wide text-sand-400 px-2 w-[15%]">Unit Price (R)</th>
                    <th className="pb-2 text-right text-xs font-semibold uppercase tracking-wide text-sand-400 px-2 w-[15%]">Amount</th>
                  ...
                  {lines.map((line) => (
                    <tr key={line.id} className="group">
                      <td className="py-1.5 pr-2">
                        <input className={tdInput + ' w-full'} value={line.description} onChange={(e) => updateLine(line.id, 'description', e.target.value)} placeholder="e.g. Stop sign (R1) — supply & erect" />
                      </td>
                      <td className="py-1.5 px-2">
                        <input className={tdInput + ' text-right'} type="number" min={0} step={1} value={line.qty} onChange={(e) => updateLine(line.id, 'qty', parseFloat(e.target.value) || 0)} />
                      </td>
                      <td className="py-1.5 px-2">
                        <input className={tdInput} value={line.unit} onChange={(e) => updateLine(line.id, 'unit', e.target.value)} placeholder="m², lm…" />
                      </td>
                      <td className="py-1.5 px-2">
                        <input className={tdInput + ' text-right'} type="number" min={0} step={0.01} value={line.unitPrice} onChange={(e) => updateLine(line.id, 'unitPrice', parseFloat(e.target.value) || 0)} />
                      </td>
                      <td className="py-1.5 px-2 text-right text-sand-300 tabular-nums">{fmt(lineAmount(line))}</td>
                      <td className="py-1.5 text-right">
                        <button onClick={() => removeLine(line.id)} className="opacity-0 group-hover:opacity-100 text-sand-500 hover:text-red-400 transition-all p-1" title="Remove line">
            ...
            {lines.length === 0 && (
              <p className="text-center text-xs text-sand-500 py-6">No lines yet. Click &ldquo;Add Line&rdquo; or choose a preset.</p>
            )}
            ...
            <div className="mt-4 flex justify-end">
              <table className="text-sm border-collapse">
                <tbody>
                  <tr>
                    <td className="text-sand-400 pr-8 py-1">Subtotal (excl. VAT)</td>
                  ...
                  <tr className="border-t border-charcoal-600">
                    <td className="pt-2 pr-8 font-bold text-sand-100">Total</td>
                    <td className="pt-2 text-right font-bold text-ember-400 tabular-nums text-base">{fmt(total)}</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <div className="rounded border border-charcoal-700 bg-charcoal-800 p-5">
            ...
            <textarea className={inputCls + ' resize-none'} rows={3} value={meta.notes} onChange={(e) => setMeta((p) => ({ ...p, notes: e.target.value }))} placeholder="Scope clarifications, exclusions, site access requirements…" />
          </div>

          {/* Image appendix */}
          <div className="rounded border border-charcoal-700 bg-charcoal-800 p-5 space-y-3">
            <div>
              <h3 className="text-sm font-bold uppercase tracking-wide text-sand-200">Appendix Image</h3>
              <p className="text-xs text-sand-500 mt-0.5">Optional — attaches as a third page (Appendix A) with the image and caption.</p>
            </div>
            ...
            {imageDataUrl ? (
              <div className="space-y-3">
                <div className="relative rounded overflow-hidden border border-charcoal-600">
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img src={imageDataUrl} alt="Appendix preview" className="w-full max-h-48 object-contain bg-charcoal-900" />
                  <button
                    onClick={removeImage}
                    className="absolute top-2 right-2 rounded bg-charcoal-900/80 p-1.5 text-sand-300 hover:text-red-400 transition-colors"
                    title="Remove image"
                  >
                ...
                <div>
                  ...
                  <input className={inputCls} value={imageCaption} onChange={(e) => setImageCaption(e.target.value)} placeholder="e.g. Site photo — parking area, viewed from entrance" />
                </div>
              </div>
            ) : (
              <button
                onClick={() => fileInputRef.current?.click()}
                className="flex w-full items-center justify-center gap-2 rounded border border-dashed border-charcoal-600 py-6 text-sm text-sand-400 hover:border-ember-500 hover:text-sand-200 transition-colors"
              >
          ...
          <button onClick={generate} className="w-full rounded bg-ember-500 py-3 font-semibold text-charcoal-900 hover:bg-ember-400 transition-colors">
            Preview Quote
          </button>
        </div>

        {/* ══ RIGHT: PREVIEW ══ */}
        <div className="w-full 2xl:w-[240mm]">
          {finalQuote ? (
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-sand-400">
                    ...
                    {finalQuote.imageDataUrl && <span> &nbsp;·&nbsp; + Appendix</span>}
                  </p>
                </div>
                <button onClick={printQuote} className="flex items-center gap-2 rounded bg-moss-600 px-5 py-2 text-sm font-semibold text-white hover:bg-moss-500 transition-colors">
              ...
              <div className="overflow-auto rounded border border-charcoal-600 bg-white shadow-lg">
                <QuoteDocument q={finalQuote} />
              </div>
            </div>
          ) : (
            <div className="flex h-full min-h-[400px] items-center justify-center rounded border border-dashed border-charcoal-600 bg-charcoal-800/50 2xl:sticky 2xl:top-24">
              <div className="text-center text-sand-400 px-8">
                <svg xmlns="http://www.w3.org/2000/svg" className="mx-auto mb-3 h-10 w-10 opacity-40" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                </svg>
                <p className="text-sm">Fill in the details and click<br /><span className="font-semibold text-ember-400">Preview Quote</span></p>
              </div>
            </div>
          )}
        </div>
