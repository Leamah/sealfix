export const COMPANY = {
  ...
  description:
    'South African specialist contractor for sealing, surfacing, line marking, and signage. Serving commercial, industrial, and municipal clients across 8 provinces.',
